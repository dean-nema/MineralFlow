...
class PrintBtn extends StatelessWidget {
  final String title;
  final VoidCallback func;
  const PrintBtn({super.key, required this.title, required this.func});
    ...
    return Container(
      ...
      child: ElevatedButton(
        ...
        child: Column(
          ...
          children: [
            Image.asset("assets/images/Printer.png", height: 60, width: 80),
